...
from appium_AutoTest.PageObjects.userInfo_page import UserInfoPage
from appium_AutoTest.PageObjects.invest_page import InvestPage
from appium_AutoTest.TestDatas.invest_testdatas import *
